...
export class TranslationService {
  ...
  german = ['Über mich', 'Projekte', 'Über mich', 'Projekte', 'Kontakt', 'Hallo! Ich bin Jan', 'Entwickler', 'Lass uns zusammen arbeiten', 'Ich bin ein Fullstack-Entwickler mit Sitz in Berlin, Deutschland. Es macht mir Spaß, Designern und Unternehmen dabei zu helfen, ihre Ideen in die Realität umzusetzen. Ich freue mich darauf, meine Entwicklerkarriere mit einer Stelle als Junior-Webentwickler fortzusetzen. <br> <br> Wenn Sie glauben, dass ich gut zu Ihren Projekten passen würde, kontaktieren Sie mich!', 'Nachricht senden', 'Projekte', 'Dieser Abschnit zeigt eine Auswahl meiner Arbeiten – testen Sie sie gerne aus', 'Alle', 'Spring-, Lauf- und Wurfspiel basierend auf einem objektorientierten Ansatz. Hilf Pepe, Münzen und Tabasco-Salsa zu finden, um gegen die verrückte Henne zu kämpfen.', 'Vom Kanban-System inspirierter Aufgabenmanager. Erstellen und organisieren Sie Aufgaben mithilfe von Drag-and-Drop-Funktionen und weisen Sie Benutzer und Kategorien zu','Ein Pokedex, der auf einer API basiert, um Informationen über verschiedene Arten von Pokémon zu katalogisieren und abzurufen.', 'Kontakt', 'Haben Sie ein Problem zu lösen', 'Kontaktieren Sie mich über dieses Formular. Ich bin daran interessiert, von Ihren Ideen zu hören, Sie kennenzulernen und mit meiner Arbeit zu Ihren Projekten beizutragen', 'Brauchen Sie einen Fullstack-Entwickler? Kontaktieren Sie mich!', 'Senden', 'Die E-Mail konnte nicht versender werden', 'Die E-Mail wurde erfolgreich versandt', 'Impressum', 'Kollaborative Plattform für Teams, die Messaging bietet. Es erleichtert die Kommunikation und Zusammenarbeit in Echtzeit für Unternehmen.', 'Videoflix ist eine Angular-Webplattform, die Zugriff auf eine Vielzahl von Videos aus einer eigenen Django-Datenbank bietet. Sie wird auf einem vServer dauerhaft gehostet und hat eine eigene Authentifizieung implementiert.'];
  ids = ['about-me-button', 'my-work-button', 'burger-about-me-button', 'burger-my-work-button', 'burger-contact-button', 'header-span1', 'header-span3', 'about-me-title', 'about-me-text', 'button-about-me', 'my-work-title', 'my-work-text', 'button-all', 'el-pollo-loco-text', 'join-text', 'pokedex-text', 'contact-title', 'contact-span1', 'contact-span2', 'contact-span3', 'button-contact', 'error', 'succes', 'imprint-text1', 'da-bubble-text', 'videoflix-text'];
  english = ['About me', 'My work', 'About me', 'My work', 'Contact', 'Hello! I am Jan', 'Developer', "Let's work together", 'I am a Front-end developer based in Berlin, Germany. I enjoy helping designers and companies bring their ideas into real life. I am looking forward to continuing my developer career with a job in a junior web developer position. <br> <br> If you think I’d be a good match for your projects, contact me!', 'Send a message', 'My work', 'This page is a sample of my work - please feel free to try them out', 'All', 'Jump, run and throw game based on object-oriented approach. Help Pepe to find coins and tabasco salsa to fight against the crazy hen.', 'Task manager inspired by the Kanban System. Create and organize tasks using drag and drop functions, assign users and categories','API-based Pokedex, to catalog and obtain information about various species of Pokémon.', 'Contact', 'Got a problem to solve?', 'Contact me through this form, I am interested in hearing you, knowing your ideas and contributing to your projects with my work', 'Need a Fullstack Developer? Contact me!', 'Say hello', 'The email sending failed', 'The email was sent successfully', 'Imprint','Collaborative platform for teams that offers messaging. It makes real-time communication and collaboration easier for businesses.','Videoflix is ​​an Angular web platform that provides access to a variety of videos from its own Django database. It is permanently hosted on a vServer and has its own authentication implemented.'];
